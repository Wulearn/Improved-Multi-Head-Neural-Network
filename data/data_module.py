...
from caxton.src.data.dataset import ParametersDataset
...
class ParametersDataModule(pl.LightningDataModule):
    def __init__(
        ...
        self.use_pumpback_speed = pumpback_speed
    ...
    def setup(self, stage=None, save=False, test_all=False):
        ...
        self.dataset = ParametersDataset(
            ...
            pumpback=self.use_pumpback,
            pumpback_speed=self.use_pumpback_speed,
            speed=self.use_speed,
